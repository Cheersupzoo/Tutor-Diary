...
class ReceiptScreen extends StatelessWidget {
  ...
  const ReceiptScreen({Key key, @required this.id, @required this.pid})
      : super(key: key);
                    ...
                    children: <Widget>[
                      Stack(children: <Widget>[
                        RepaintBoundary(
                          ...
                          child: new RecieptPartScreenshot(
                            student: student,
                            id: id,
                            course: course,
                            pid: pid,
...
class RecieptPart extends StatelessWidget {
  const RecieptPart({
    Key key,
...
class RecieptPartScreenshot extends StatelessWidget {
  const RecieptPartScreenshot({
    Key key,
    @required this.student,
    @required this.id,
    @required this.course,
